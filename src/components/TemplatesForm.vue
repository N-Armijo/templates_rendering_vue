...
const tipoLetraSeleccionada = ref('');
const tamanoLetraSeleccionada = ref('');
const opaco = ref(false);

// Definir arrays directamente en variables ref para opciones de selección
const tipoLetra = ref(['georgia', 'roboto']);
const tamanoLetra = ref([
